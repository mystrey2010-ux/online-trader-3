...
**Status:** PAPER/SANDBOX | EMERGENCY_STOP: CLEARED | Engine: RUNNING | Trades: 7 total (3 strategic)
...
## Current Daily Loss Check
- Daily net PnL: $0.1125 (within daily loss limit of -$4.0484)
