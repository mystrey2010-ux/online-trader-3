...
| D-065 | ohlcv_limit tunable via brain: BEAR→38, SIDEWAYS→75, BULL→38 bars | main.py run_cycle(), _generate_and_apply_hypotheses() | v2.17 |
...
| D-071 | T-020: Stop-loss logic extracted into _execute_stop_loss() helper for code clarity and maintainability | main.py _execute_stop_loss(), run_cycle() | v2.18 |
